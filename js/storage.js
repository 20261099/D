...
class StorageManager {
  ...
  // ── 사용자 프로필 ──────────────────────────────────────
  async saveProfile(p)  { await this._set('user_profile', p); }
  async loadProfile()   { return await this._get('user_profile', { nickname: '', bgColor: '#c8b8f0', characterImg: 'images/suryong/su1.jpg' }); }
